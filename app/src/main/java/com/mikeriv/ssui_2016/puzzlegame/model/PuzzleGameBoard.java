...
public class PuzzleGameBoard {
    ...
    public boolean areTilesNeighbors(
        ...
        // TODO - check if tiles are neighbors

        if (secondTileRow == firstTileRow){
            if (secondTileCol == firstTileCol + 1 || secondTileCol == firstTileCol - 1){
                return true;
            }
        }
        else if (secondTileRow == firstTileRow + 1 || secondTileRow == firstTileRow - 1){
            if (secondTileCol == firstTileCol){
                return true;
            }
        }
        return false;
    ...
    public final void swapTiles(
       ...
       // TODO - swap two tiles at the given indices
        PuzzleGameTile puzzleGameTileHolder = mTileGrid[firstTileRow][firstTileCol];
        mTileGrid[firstTileRow][firstTileCol] = mTileGrid[secondTileRow][secondTileCol];
        mTileGrid[secondTileRow][secondTileCol] = puzzleGameTileHolder;
    }
